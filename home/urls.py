...
from home.views import Leave, NewUser, UserLoginView, UserSignupView, ManagerGet, GrantLeave,DeclineUser,LeaveBalance,ProfileCard,GetManager
...
urlpatterns = [
    ...
    path("profilecard",ProfileCard.as_view()),
    path("getManager",GetManager.as_view()),
